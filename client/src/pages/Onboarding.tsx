      ...
      >
        ...
        <div className="flex justify-between mt-8">
          ...
          <button
            onClick={handleNext}
            disabled={isLoading}
            className="px-8 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl font-medium hover:from-blue-700 hover:to-indigo-700 disabled:opacity-50"
          >
